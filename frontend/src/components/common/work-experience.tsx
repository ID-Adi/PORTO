...
import type { ChevronsUpDownIconHandle } from "@/components/anim/chevrons-up-down-icon"
import { ChevronsUpDownIcon } from "@/components/anim/chevrons-up-down-icon"
...
export function WorkExperience({
  ...
  return (
    <div className={cn("bg-background pr-2 pl-4 text-foreground", className)}>
...
export function ExperienceItem({ experience }: ExperienceItemProps) {
  return (
    <div className="space-y-4 border-b border-line py-4 last:border-b-0">
      <div className="not-prose flex items-center gap-3">
        <div className="flex size-6 shrink-0 items-center justify-center">
          {experience.companyLogo ? (
            ...
            <span className="flex size-2 rounded-full bg-muted-foreground/35" />
          )}
        </div>
        ...
        {experience.isCurrentEmployer && (
          ...
          >
            <span className="absolute inline-flex size-3 animate-ping rounded-full bg-foreground opacity-30" />
...
function Skill({ className, ...props }: ComponentProps<"span">) {
  return (
    <span
      className={cn(
        "inline-flex items-center rounded-md border border-line bg-muted/50 px-1.5 py-0.5 font-mono text-xs text-muted-foreground",
        className
      )}
      {...props}
    />
